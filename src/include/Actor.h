...
public:
	...
	Ogre::Real getMaxSpeed() { return mMaxSpeed; }
	void setMaxSpeed(Ogre::Real maxSpeed) { mMaxSpeed = maxSpeed; }
	...
	virtual bool onCollision(CompetitorMarble *otherActor, btManifoldPoint& cp) { return false; }
	virtual bool onCollision(StaticActor *otherActor, btManifoldPoint& cp) { return false; }
	virtual bool onCollision(CollectibleMarble *otherActor, btManifoldPoint& cp) { return false; }
	virtual bool onCollision(HealthPowerUp *otherActor, btManifoldPoint& cp) { return false; }

	bool removeMe() { return mFlaggedForRemoval; }
	...
	Ogre::Vector3 groundNormal() { return mGroundNormal; }
	Ogre::Vector3 getSpawn() { return mSpawnPoint; }
